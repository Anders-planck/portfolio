  ...
  return (
    <div className="space-y-4 mb-8">
        ...
        <Popover open={searchOpen} onOpenChange={setSearchOpen}>
            ...
            >
              <div className="flex items-center gap-2 flex-1 truncate">
                ...
                <span className="truncate">
                  {searchQuery || t('search.placeholder', { type: 'posts' })}
                </span>
              </div>
              {searchQuery && (
                <X
          ...
          <PopoverContent className="w-full min-w-[400px] max-w-[500px] p-0" align="start">
            <Command shouldFilter={false}>
              <CommandInput
                placeholder={t('search.inputPlaceholder', { type: 'posts' })}
                value={searchQuery}
              ...
              <CommandList>
                {isSearching ? (
                  ...
                  <CommandEmpty>{t('search.noResults', { type: 'posts' })}</CommandEmpty>
                ) : (
                  <CommandEmpty>{t('search.typeToSearch', { type: 'posts' })}</CommandEmpty>
                )}
              </CommandList>
            </Command>
          </PopoverContent>
      ...
      <div className="text-sm text-muted-foreground">
        {t('showing', { count: filteredPosts.length, total: posts.length, type: 'posts' })}
      </div>
    </div>
  )
}
